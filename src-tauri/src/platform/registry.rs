...
mod tests {
    ...
    fn test_registry_roundtrip() {
        ...
        assert!(delete_result.is_ok(), "Failed to delete: {:?}", delete_result);
    ...
    fn test_value_exists_nonexistent() {
        let result = WindowsRegistry::value_exists(
            "Software\\SwatNotes\\NonExistent",
            "NonExistentValue",
        );
    ...
    fn test_delete_nonexistent_value() {
        ...
        let result = WindowsRegistry::delete_value(
            "Software\\SwatNotes\\NonExistent",
            "NonExistentValue",
        );
    ...
    fn test_autostart_functions() {
        ...
        assert!(toggle_on.unwrap(), "Toggle should return true (now enabled)");
