...
impl RemindersService {
    ...
    pub async fn create_reminder(
        ...
        self.repo.create_reminder(note_id, trigger_time, sound_enabled, sound_type, shake_enabled, glow_enabled).await
    }
...
mod tests {
    ...
    async fn test_list_active_reminders() {
        ...
        service.create_reminder(&note.id, trigger1, None, None, None, None).await.unwrap();
        service.create_reminder(&note.id, trigger2, None, None, None, None).await.unwrap();
